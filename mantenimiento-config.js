...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    Array.prototype.slice.call(document.body.children).forEach(function (child) { child.remove(); });
